...
const CotizadorReactivo = ({
    ...
    useEffect(() => {
        ...
        if(element != null) {
            ...
            var offsetPosition = elementPosition - 200 + window.pageYOffset;
            window.scrollTo({
                top: offsetPosition,
                behavior: "smooth"
            });
    ...
    return (
        ...
        {filling ? 
        <>
            <div style={{display: (isTabletOrMobile ? "block" : "-webkit-box"), marginTop: (winOffset <= 10 ? "0px": "-78px"), justifyContent: "center", position: "fixed", width: "100%", zIndex: "1"}} >
                <div className={[(isTabletOrMobile ? "bloquesMobile" : ""), (store.formFieldVisibility[1] ? "bloquesCabeceraReactiva" : "bloqueEscondido")].join(" ")} onClick={() => actions.updateToScroll("tipo")}>
                    ...
                    <p className={isTabletOrMobile ? "":"heavyWeight"}>{store.travelData.tipo}</p>
                </div>
                <div className={[(isTabletOrMobile ? "bloquesMobile" : ""), (store.formFieldVisibility[2] ? "bloquesCabeceraReactiva" : "bloqueEscondido")].join(" ")} onClick={() => actions.updateToScroll("origen")}>
                    <p>origen</p> <br />
                    <p className={[(isTabletOrMobile ? "":"heavyWeight"), "overflowDots"].join(" ")}>{textoOrigen}</p>
                </div>
                    ...
                    <div style={{display: (isTabletOrMobile ? "block" : "flex"), justifyContent: "space-evenly"}}>    
                        ...
                        <input style={{opacity: "0"}} type="radio" id="por dia"  name="tipo" value="Viajes por dia" onChange={e => setTipo(e.target.value)}/>
                            <div style={{display: (isTabletOrMobile ? "none":"block")}}>
                                <img src={require('./../../assets/images/por-dia-selected.svg')}
                                ...
                                <img src={require('./../../assets/images/por-dia-unselected.svg')}
                        ...
                        <div style={{display: (isTabletOrMobile ? "none":"block")}}>
                            <img src={require('./../../assets/images/Anuales-selected.svg')}
                            ...
                            <img src={require('./../../assets/images/Anuales-unselected.svg')}
                    ...
                    {store.formFieldVisibility[2] ? <>{/*<select className="inputCotizador" onChange = {e => {setDestino(e.target.value); setTextoDestino(e.target.options[e.target.selectedIndex].text)}}>
                                                        ...
                                                        <div style={{display: (isTabletOrMobile ? "block" : "flex"), justifyContent: "space-evenly"}}>    
                                                            <label>
                                                                ...
                                                                <div style={{display: (isTabletOrMobile ? "none":"block")}}>
                                                                    <img src={require('./../../assets/images/big-ben-selected.svg')}
                                                                        alt="Europa selected"
                                                                        width={128}
                                                                        height={128}
                                                                    ...
                                                                    <img src={require('./../../assets/images/big-ben-unselected.svg')}
                                                            ...
                                                            <label>
                                                                ...
                                                                <div style={{display: (isTabletOrMobile ? "none":"block")}}>
                                                                    <img src={require('./../../assets/images/statue-of-liberty-selected.svg')}
                                                                        alt="EEUU selected"
                                                                        width={128}
                                                                        height={128}
                                                                    ...
                                                                    <img src={require('./../../assets/images/statue-of-liberty-unselected.svg')}
                                                                        alt=" EEUU unselected"
                                                                        width={128}
                                                                        height={128}
                                                            ...
                                                            <label>
                                                                ...
                                                                <div style={{display: (isTabletOrMobile ? "none":"block")}}>
                                                                    <img src={require('./../../assets/images/Mundo-selected.svg')}
                                                                        alt="Mundo selected"
                                                                        width={128}
                                                                        height={128}
                                                                    ...
                                                                    <img src={require('./../../assets/images/Mundo-unselected.svg')}
