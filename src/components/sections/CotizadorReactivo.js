    ...
    return (
        ...
        >
            <div style={{ margin: "0px 20%" }}>
                <form>
                    {store.formFieldVisibility[0] ? <><select>
                        ...
                        <Button tag="a" color="primary" wideMobile onClick={() => actions.changeVisibility(1, true)}>
                            Actualizar
                                                      </Button>
                    </> : null
                    }
                    <br />
                    {store.formFieldVisibility[1] ? <><select id="websitebundle_filterquote_origin" name="websitebundle_filterquote[origin]" required="required" class="general_input italic fsize-12 uppercase mb15" data-placeholder="Origen Del Viaje" placeholder="Origen Del Viaje">
                        ...
                        <br />
                        <Button tag="a" color="primary" wideMobile onClick={() => actions.changeVisibility(2, true)}>
                            Actualizar
                        </Button>
                    </> : null
                    }
                    <br />
                    {store.formFieldVisibility[2] ? <><select>
                                                        <option selected value="destino">Destino</option>
                                                        <option value="Europa">Europa</option>
                                                        <option value="Estados Unidos">Estados Unidos</option>
                                                        <option value="Resto del mundo">Resto del mundo</option>
                                                      </select>
                                                      <br />
                        <Button tag="a" color="primary" wideMobile onClick={() => actions.changeVisibility(3, true)}>
                            Actualizar
                                                      </Button>
                    </> : null
                    }
                    <br />
                    {store.formFieldVisibility[3] ? <><DatePicker />
                                                      <br />
                    </> : null
                    }
